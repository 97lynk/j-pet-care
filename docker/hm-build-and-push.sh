...
if [ -z "${REGISTRY_HOST_HM}" ]; then
    echo "Error: REGISTRY_HOST_HM is not set. Define it in docker/.env or as an environment variable."
    exit 1
fi

export registry_host=${REGISTRY_HOST_HM}
export tenant_id=hm
